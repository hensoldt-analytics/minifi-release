...
public class FlowParserTest {
    ...
    public void testCanParseFlow() {
        ...
        NodeList processors = parsedFlow.getElementsByTagName(MiNiFi.PROCESSOR_TAG_NAME);
        NodeList controllerServices = parsedFlow.getElementsByTagName(MiNiFi.CONTROLLER_SERVICE_TAG_NAME);
        NodeList reportingTasks = parsedFlow.getElementsByTagName(MiNiFi.REPORTING_TASK_TAG_NAME);
